...
public class UpdateProfileWindow extends JFrame {
    ...
    public UpdateProfileWindow(String userName) {
        ...
        updateButton.addActionListener(e -> {
            ...
            try (Connection con = DBConnection.getConnection()) {
                PreparedStatement ps = con.prepareStatement("UPDATE admin SET name = ?, email = ?, password = ? WHERE name = ?");
    ...
    private void fetchUserDetails(JLabel currentNameValue, JLabel currentEmailValue, JLabel currentPasswordValue) {
        ...
        try {
            ...
            ps = con.prepareStatement("SELECT name, email, password FROM admin WHERE name = ?");
