...
public class UpdateStudentProfileWindow extends JFrame {
    private String studentId;

    public UpdateStudentProfileWindow(String studentId) {
        ...
        fetchStudentDetails(currentNameValue, currentEmailValue, currentPasswordValue);
        ...
        updateButton.addActionListener(e -> {
            ...
            try (Connection con = DBConnection.getConnection()) {
                PreparedStatement ps = con.prepareStatement("UPDATE students SET name = ?, email = ?, password = ? WHERE student_id = ?");
                ...
                fetchStudentDetails(currentNameValue, currentEmailValue, currentPasswordValue); // Refresh the current details
            } catch (Exception ex) {
                ex.printStackTrace();
    ...
    private void fetchStudentDetails(JLabel currentNameValue, JLabel currentEmailValue, JLabel currentPasswordValue) {
        Connection con = null;
        PreparedStatement ps = null;
        ResultSet rs = null;
        try {
            con = DBConnection.getConnection();
            ps = con.prepareStatement("SELECT name, email, password FROM students WHERE student_id = ?");
